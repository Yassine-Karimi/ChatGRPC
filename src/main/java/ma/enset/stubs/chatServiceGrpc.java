...
public final class chatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Chat.messageBroadcast,
      ma.enset.stubs.Chat.messageResponse> getBroadCastMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "broadCast",
      requestType = ma.enset.stubs.Chat.messageBroadcast.class,
      responseType = ma.enset.stubs.Chat.messageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Chat.messageBroadcast,
      ma.enset.stubs.Chat.messageResponse> getBroadCastMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Chat.messageBroadcast, ma.enset.stubs.Chat.messageResponse> getBroadCastMethod;
    if ((getBroadCastMethod = chatServiceGrpc.getBroadCastMethod) == null) {
      synchronized (chatServiceGrpc.class) {
        if ((getBroadCastMethod = chatServiceGrpc.getBroadCastMethod) == null) {
          chatServiceGrpc.getBroadCastMethod = getBroadCastMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Chat.messageBroadcast, ma.enset.stubs.Chat.messageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "chatService", "broadCast"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.messageBroadcast.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.messageResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new chatServiceMethodDescriptorSupplier("broadCast"))
                  .build();
          }
        }
     }
  ...
  public static abstract class chatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void broadCast(ma.enset.stubs.Chat.messageBroadcast request,
        io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.messageResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                ma.enset.stubs.Chat.messageBroadcast,
                ma.enset.stubs.Chat.messageResponse>(
                  this, METHODID_BROAD_CAST)))
          .build();
    }
  }
  ...
  public static final class chatServiceBlockingStub extends io.grpc.stub.AbstractStub<chatServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<ma.enset.stubs.Chat.messageResponse> sendTo(
    ...
    /**
     */
    public java.util.Iterator<ma.enset.stubs.Chat.messageResponse> broadCast(
        ma.enset.stubs.Chat.messageBroadcast request) {
      return blockingServerStreamingCall(
  ...
  private static final int METHODID_BROAD_CAST = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_SEND_TO:
          serviceImpl.sendTo((ma.enset.stubs.Chat.messageRequest) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.messageResponse>) responseObserver);
          break;
        case METHODID_BROAD_CAST:
          serviceImpl.broadCast((ma.enset.stubs.Chat.messageBroadcast) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.messageResponse>) responseObserver);
          break;
        default:
